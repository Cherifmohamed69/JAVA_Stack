...
public class AlfredTest {
    public static void main(String[] args) {
        ...
        // NINJA BONUS: Testing overloaded guestGreeting
        String testNinjaBonusGreeting = alfredBot.guestGreeting("Bruce Wayne", "evening");
        System.out.println(testNinjaBonusGreeting);
        
        // SENSEI BONUS: Testing customAlfredQuote
        String customQuote = alfredBot.customAlfredQuote();
        System.out.println(customQuote);
    }
}
